        ...
        <div className="rounded-2xl bg-slate-950 backdrop-blur-xl shadow-2xl border-t-3 border-gradient-to-r from-indigo-400 via-violet-500 to-rose-500 p-8">
          <div className="flex flex-col px-5 lg:px-20 md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex flex-wrap gap-6 justify-center">
             ...
             <a href="/products" className="text-slate-200 hover:text-fuchsia-400 transition font-medium">Products</a>
          ...
          <div className="mt-8 border-t border-white/10 pt-4 text-center text-slate-500 text-xs">
            &copy; {new Date().getFullYear()} Product-Nest. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
